...
[选定封面与分辨率说明](assets/README.md)应单独看：当前原图为 1024 × 1536，放到 A4 页约 131 PPI。流程已能稳定导出高清 PDF 页面，但放大页面不等于取得高清封面母版。正式印刷的封面还需重绘或取得真正高分辨率来源；生成图中没有经过核对的 ISBN、页码和许可一律不用。
