...
7. 中断、重试与恢复：如何避免重复副作用？
8. [Tool、Skill、Extension、Package、MCP：到底扩展了什么？](extensibility-layers.md)；多 Agent 的拆分与交接仍待专题。
9. 观察、测试与评测：什么证据足以宣称完成？

首张[概念总览图](../../figures/agent-loop/README.md)是草稿，不代替上述专题的细节图；“多 Agent”一章先解决控制权与执行者数量的区别，具体交接协议仍待专题。
