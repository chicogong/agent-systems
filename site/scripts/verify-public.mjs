...
const expected = ['index.html', 'feedback.html', ...sidebar.flatMap((part) => part.items.map((item) => item.link.slice(1) + '.html'))]
...
const indexPages = new Set(['feedback.html', 'concepts.html', 'systems.html', 'comparisons.html', 'sources.html'])
for (const file of expected) {
  ...
  if (file !== 'index.html' && file !== 'feedback.html' && !html.includes('mailto:ghr7719@gmail.com')) throw new Error(`${file}: missing chapter feedback link`)
